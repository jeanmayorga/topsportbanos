<?php
    $titulo = "Green Forest Cuyabeno 5 Dias 4 Noches";
        ...
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <ul class="list-ext design">
                    <li>
                        <h2>Sumérgete en la Selva de Ecuador - Cuyabeno - Día 1</h2>    
                    ...
                    <li>
                        <h2>Explora la vida salvaje de la Reserva Cuyabeno - Día 2</h2>
                    ...
                    <li>
                        <h2>Vive, descubre la Leyenda de la Cultura Siona - Día 3</h2>
                        <p>Temprano en la mañana degustaremos el desayuno para viajar en canoa hacia la Comunidad Indígena Siona, en la misma podremos interactuar y aprender sobre sus tradiciones, cultura y costumbres. En la misma aprenderemos a elaborar el Casabe un plato típico de esta tribu ancestral. El almuerzo nos serviremos en la comunidad y finalmente conoceremos al Chamán, el mismo nos hará percibir e interactuar con su mundo espiritual, canalizando sus energías, habilidades visionarias, curativas y adivinatorias adquiridas a lo largo de los años. Así como usted también tendrá tiempo para adquirir las bellas artesanías hechas por los lugareños.</p>
                    </li>
                    <li>
                        <h2>Navegando en la Amazonía Ecuatoriana - Día 4</h2>
                        <p>Se realizará una visita en los alrededores de la Reserva para la observación de aves por canoa tradicional de la selva llamada "quilla", de igual forma luego del desayuno continuaremos con una visita a una de las lagunas vírgenes de la Reserva Faunística Cuyabeno; donde podremos observar una gran cantidad de aves de la amazonía ecuatoriana, y remaremos en una quilla (canoa de madera tradicional de la selva) a lo largo de este trayecto podremos observar gran cantidad de monos, tucanes, guacamayos, reptiles, y aves de la zona. Luego del almuerzo podremos descansar junto al río y desde luego si te gusta kayakear podremos hacerlo cerca a nuestro Ecolodge. Por la tarde haremos nuestra última visita a la Laguna de Cuyabeno.</p>
                    </li>
                    <li>
                        <h2>De Cuyabeno hacia la Civilización - Día 5</h2>
                        <p>Muy por la mañana haremos una observación de aves río abajo, después nos serviremos el desayuno y viajaremos por el Río Cuyabeno de retorno hacia la civilización. El transporte nos llevará desde el ingreso al Parque Nacional Cuyabeno hacia Lago Agrio (punto de encuentro) para luego continuar con su viaje habitual en Ecuador. Fin de nuestros servicios.</p>
                    </li>
                </ul>
