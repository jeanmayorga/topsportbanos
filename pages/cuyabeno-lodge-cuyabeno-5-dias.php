<?php
    $titulo = "Cuyabeno Lodge Cuyabeno 5 Dias";
        ...
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <ul class="list-ext design">
                    ...
                    <li>
                        <h2>Día 4</h2>
                        <p>Temprano en la mañana observación de aves. Después del desayuno, caminata en la selva para explorar plantas y vida animal. En la tarde excursión para explorar pequeñas lagunas.</p>
                    </li>
                    <li>
                        <h2>Día 5</h2>
                ...
                <div class="ui stackable grid priceTag">
                    ...
                    <div class="two wide column">
                        ...
                        <div class="content">$ 475 USD</div>
                        <div class="content">$ 550 USD</div>
                    </div>
