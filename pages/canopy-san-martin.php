<?php
    $titulo = "Canopy San Martin";
    $tag = "canopy-san-martin";
    $precio = 20;
    
    $keywords = "Baños, Canopy, Canopy Banos Ecuador, Canopy Ecuador, Canopy Baños, Top Sport Adventure, San Martin";
    $description = "Esta aventura solo está a 10 minutos de Baños. Todo el equipo está certificado y homologado. Este es el canopy más extremo que tenemos en el cantón. Primero es un cable de 850 metros. Luego 90 metros de puente tibetano. Después una vía ferrata de 90 metros y terminamos con un canopy de 350 metros.";
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <main role="main" class="ui fluid container">
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <h2>Intinerario</h2>
                <p>Esta aventura solo está a 10 minutos de Baños. Todo el equipo está certificado y homologado. Este es el canopy más extremo que tenemos en el cantón. Primero es un cable de 850 metros. Luego 90 metros de puente tibetano. Después una vía ferrata de 90 metros y terminamos con un canopy de 350 metros.</p>
