<?php
    $titulo = "Canyoning Chamana";
    $tag = "canyoning-Chamana";
    $precio = 20;
    
    $keywords = "Baños, Canyoning, Canyoning Banos Ecuador, Canyoning Ecuador, Canyoning Baños, Top Sport Adventure, deportes, agua, cascadas, chamana";
    $description = "Como todos los programas de canyoning primero una capacitación previa antes de ir al cañón. Está a poca distancia del centro de la cuidad 8 minutos aproximadamente esta serie de cascadas que descienden del parque nacional Sangay.";
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <main role="main" class="ui fluid container">
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <h2>Intinerario</h2>
                <p>Como todos los programas de canyoning primero una capacitación previa antes de ir al cañón. Está a poca distancia del centro de la cuidad 8 minutos aproximadamente esta serie de cascadas que descienden del parque nacional Sangay. En el lugar de inicio tendremos la charla de seguridad, utilización del equipo, practica y luego de una corta caminata empezamos la aventura, en este lugar tenemos 4 cascadas entre 4 y 35 metros de altura, luego de terminar la actividad retornamos a Baños.</p>
