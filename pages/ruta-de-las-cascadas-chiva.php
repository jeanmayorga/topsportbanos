<?php
    $titulo = "Ruta de las Cascadas (Chiva)";
    $tag = "ruta-de-las-cascadas-chiva";
    $precio = 8;
    
    $keywords = "Baños, ruta de las cascadas, Cascadas, bicicletas, bikes in baños, tarabita, agoyan, puenting";
    $description = "TOUR en chiva a las cascadas contamos con unidades nuevas guías nativos y naturalistas la duración del tour es de 3 horas son 7 cascadas y miradores en la última tendremos una caminata.";
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <main role="main" class="ui fluid container">
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <h2>Intinerario</h2>
                <p>TOUR en chiva a las cascadas contamos con unidades nuevas guías nativos y naturalistas la duración del tour es de 3 horas son 7 cascadas y miradores en la última tendremos una caminata.</p>
