<?php
    ...
    $keywords = "Baños, escalada, Escalada en Baños Ecuador, Escalada Ecuador, Escalada Baños, Top Sport Adventure, deportes";
    $description = "En esta ciudad nos encontramos rodeados de muros naturales de roca basáltica gracias a las diferentes erupciones del volcán Tungurahua el lugar más idóneo para realizar la actividad Escalada en roca o Rock Climbing es el sector de san Martin que se encuentra a diez minutos del centro de la ciudad.";
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <main role="main" class="ui fluid container">
        <div class="ui stackable grid container block first">
            <article class="eleven wide column">
                ...
                <h2>Intinerario</h2>
                <p>En esta ciudad nos encontramos rodeados de muros naturales de roca basáltica gracias a las diferentes erupciones del volcán Tungurahua el lugar más idóneo para realizar la actividad Escalada en roca o Rock Climbing es el sector de san Martin que se encuentra a diez minutos del centro de la ciudad. Al llegar al punto de inicio el guía les brindara una charla de técnicas de seguridad como también nos indicara los diferentes movimientos y posiciones del cuerpo al estar pegados o subidos en la roca que le ayudaran a escalar de mejor manera el acantilado.<br>Esta será sin duda la mejor experiencia e inmejorable en baños Ecuador.</p>
